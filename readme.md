...
What setup.sh does:
  ...
  - Detached Alias: Adds a specialized alias to your ~/.bashrc to ensure the GUI runs independently of the terminal session: alias repos='~/.local/bin/repos > /dev/null 2>&1 & disown'
