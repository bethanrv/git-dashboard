...
class DarkRepoLauncher:
    def __init__(self, root):
        ...
        # macOS Fixed Icon Buttons
        self.btn_refresh = tk.Label(top_frame, text="↻", bg=BG_HEADER, fg=FG_TEXT, font=("SF Pro Display", 14), padx=8, cursor="hand2")
        self.btn_refresh.pack(side=tk.LEFT, padx=2)
        self.btn_refresh.bind("<Button-1>", lambda e: self.refresh_data())

        self.btn_settings = tk.Label(top_frame, text="⚙", bg=BG_HEADER, fg=FG_TEXT, font=("SF Pro Display", 14), padx=8, cursor="hand2")
        ...
        # macOS Fixed Large Action Button
